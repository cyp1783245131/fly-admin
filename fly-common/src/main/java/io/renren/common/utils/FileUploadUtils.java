...
public class FileUploadUtils {
    ...
    public FileUploadUtils(String dst, String cache, String[] fileTypes, long fileSizeMax, int cacheSizeMax)
    {
        super();
        this.dstPath=dst;
    ...
    public FileUploadUtils(String dst, String cache, String[] fileTypes)
    {
        super();
        this.dstPath=dst;
        this.cachePath=cache;
    ...
    public void uploadFile(MultipartFile file, String fileName) throws Exception{
        ...
        String fileDiskPath=dstPath;//获取文件名
        long   fileSize=file.getSize();//获取文件大小
        String fileOrigName=file.getOriginalFilename();
        String fileType=fileOrigName.substring(fileOrigName.lastIndexOf("."));
        //String fileName=String.valueOf(System.currentTimeMillis())+fileType;
        fileName=fileName+fileOrigName.substring(fileOrigName.lastIndexOf("."));
        FileOutputStream out = new FileOutputStream(fileDiskPath+File.separator+fileName);
        map.put("fileDiskpath",fileDiskPath);
        map.put("fileSize",String.valueOf(fileSize));
        map.put("fileOrigname",fileOrigName);
    ...
    //移动附件
    public boolean moveFiletoPath(File srcFile,File dstFile) {
        boolean flag=false;
        if(srcFile.exists()){
