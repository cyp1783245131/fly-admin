...
$(document).on('click', '.area-duoxuan', function () {
    console.info(vm.drainage.fanwei)
    if(vm.drainage.fanwei != null || vm.drainage.fanwei != ""){
        inputarry = vm.drainage.fanwei;
    }
...
function appendCity(thiscon, Cityxz) {
    ...
    if ($(dataCityinput).data("value") != "") {
        if(vm.drainage.fanwei == null || vm.drainage.fanwei == "") {
            inputarry = $(dataCityinput).data("value").split('-');
        }
        console.info(inputarry)
...
function svae_City() {
    ...
    console.info( $(dataCityinput).val(Cityname).context.value)
    vm.drainage.fanwei = $(dataCityinput).val(Cityname).context.value;
    Close();
}
