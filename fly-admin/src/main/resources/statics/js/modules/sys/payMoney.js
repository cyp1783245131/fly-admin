...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = "sys/payMoney/save";
            $.ajax({
                type: "POST",
                url: baseURL + url,
                contentType: "application/json",
                data: JSON.stringify(vm.payMoney),
                success: function(r){
                    if(r.code === 0){
        ...
        del: function (event) {
            ...
            confirm('确定要删除选中的记录？', function(){
                $.ajax({
                    type: "POST",
                    url: baseURL + "sys/payMoney/delete",
                    contentType: "application/json",
...
function importExp(type) {
    ...
    $.ajax({
        url : baseURL + "sys/payMoney/uploadExcel/"+type,
        type : 'POST',
        data : formData,
